...
export namespace Prisma {
  ...
  */
  ...
  export type AuthUserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "username" | "email" | "password" | "isEmailVerified" | "role" | "isBanned" | "createdAt" | "updatedAt", ExtArgs["result"]["authUser"]>
  ...
  interface AuthUserFieldRefs {
    ...
    readonly role: FieldRef<"AuthUser", 'Role'>
    readonly isBanned: FieldRef<"AuthUser", 'Boolean'>
  ...
  export type AuthUserWhereInput = {
    ...
    role?: EnumRoleFilter<"AuthUser"> | $Enums.Role
    isBanned?: BoolFilter<"AuthUser"> | boolean
  ...
  export type AuthUserScalarWhereWithAggregatesInput = {
    ...
    role?: EnumRoleWithAggregatesFilter<"AuthUser"> | $Enums.Role
    isBanned?: BoolWithAggregatesFilter<"AuthUser"> | boolean
